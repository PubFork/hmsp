<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/Volumes/Transcend/PHPWeb/maccmsV10/application/admin/view/index/login.html";i:1563267956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="/maccmsV10/static/layui/css/layui.css">
    <link rel="stylesheet" href="/maccmsV10/static/css/admin_style.css">
    <style type="text/css">
        body {
            color:#999;
...
<div class="login-box">
    <form class="layui-form layui-form-pane" method="post" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" name="verify" class="layui-input" lay-verify="verify" placeholder="验证码" maxlength="4"  max="9999"/><img id="verify_img" src="/maccmsV10/index.php/verify/index.html" onclick="this.src = this.src+'?'">
            </div>
        </div>
        <?php endif; ?>
...
<script type="text/javascript" src="/maccmsV10/static/layui/layui.js"></script>
<script type="text/javascript" src="/maccmsV10/static/js/admin_common.js"></script>
