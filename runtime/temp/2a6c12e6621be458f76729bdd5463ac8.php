<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"D:\phpStudy\PHPTutorial\WWW\maccmsV10.3.06/application/admin\view\vod\info.html";i:1563268146;s:82:"D:\phpStudy\PHPTutorial\WWW\maccmsV10.3.06\application\admin\view\public\head.html";i:1522628860;s:84:"D:\phpStudy\PHPTutorial\WWW\maccmsV10.3.06\application\admin\view\public\editor.html";i:1544100010;s:82:"D:\phpStudy\PHPTutorial\WWW\maccmsV10.3.06\application\admin\view\public\foot.html";i:1526021730;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="/maccmsV10.3.06/static/layui/css/layui.css">
    <link rel="stylesheet" href="/maccmsV10.3.06/static/css/admin_style.css">
    <script type="text/javascript" src="/maccmsV10.3.06/static/js/jquery.js"></script>
    <script type="text/javascript" src="/maccmsV10.3.06/static/layui/layui.js"></script>
    <script>
        var ROOT_PATH="/maccmsV10.3.06",ADMIN_PATH="<?php echo $_SERVER['SCRIPT_NAME']; ?>", MAC_VERSION='v10';
    </script>
</head>
<body>
<script type="text/javascript" src="/maccmsV10.3.06/static/js/jquery.jscolor.js"></script>
<?php 
...
if( (!file_exists($ue_new) && file_exists($ue_old)) || $editor=='' ){
 ...
 if($editor == 'ueditor'): ?>
<script type="text/javascript" src="/maccmsV10.3.06/static/ueditor/ueditor.config.js"></script>
<script type="text/javascript" src="/maccmsV10.3.06/static/ueditor/ueditor.all.min.js"></script>
...
<link rel="stylesheet" href="/maccmsV10.3.06/static/editor/umeditor/themes/default/css/umeditor.css" type="text/css" rel="stylesheet">
<script type="text/javascript" src="/maccmsV10.3.06/static/editor/umeditor/umeditor.config.js"></script>
<script type="text/javascript" src="/maccmsV10.3.06/static/editor/umeditor/umeditor.min.js"></script>
<script type="text/javascript">
...
<script type="text/javascript" src="/maccmsV10.3.06/static/editor/kindeditor/kindeditor-all-min.js"></script>
<script type="text/javascript">
    var EDITOR = KindEditor;
</script>
<?php elseif($editor == 'ckeditor'): ?>
<script type="text/javascript" src="/maccmsV10.3.06/static/editor/ckeditor/ckeditor.js"></script>
<script type="text/javascript">
    var EDITOR = CKEDITOR;
</script>
<?php endif; ?>
...
<script type="text/javascript" src="/maccmsV10.3.06/static/js/admin_common.js"></script>
