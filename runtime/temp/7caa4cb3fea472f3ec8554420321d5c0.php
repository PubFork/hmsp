<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\phpStudy\PHPTutorial\WWW\maccmsV10.3.06/application/admin\view\index\login.html";i:1563267955;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="login-head">
    <h1><a href="//www.vrecf.com/">苹果CMS一路陪伴，感恩有你！</a></h1>
</div>
<div class="login-box">
    <form class="layui-form layui-form-pane" method="post" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" name="verify" class="layui-input" lay-verify="verify" placeholder="验证码" maxlength="4"  max="9999"/><img id="verify_img" src="/maccmsV10.3.06/index.php/verify/index.html" onclick="this.src = this.src+'?'">
            </div>
        </div>
        <?php endif; ?>
    ...
    <div class="copyright">
        © 2008-2019 <a href="http://www.vrecf.com/?login" target="_blank">MacCMS.COM</a> All Rights Reserved.
    </div>
</div>
