...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_5d4bd92c6f6d1=explode(',',$maccms['search_hot']); if(is_array($_5d4bd92c6f6d1) || $_5d4bd92c6f6d1 instanceof \think\Collection || $_5d4bd92c6f6d1 instanceof \think\Paginator): if( count($_5d4bd92c6f6d1)==0 ) : echo "" ;else: foreach($_5d4bd92c6f6d1 as $key2=>$vo2): ?>
