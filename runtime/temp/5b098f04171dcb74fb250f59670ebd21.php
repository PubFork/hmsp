<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:39:"template/default_wap/html/vod\show.html";i:1527038095;s:88:"D:\phpStudy\PHPTutorial\WWW\maccmsV10.3.06\template\default_wap\html\public\include.html";i:1536591340;s:85:"D:\phpStudy\PHPTutorial\WWW\maccmsV10.3.06\template\default_wap\html\public\head.html";i:1527560351;s:87:"D:\phpStudy\PHPTutorial\WWW\maccmsV10.3.06\template\default_wap\html\public\paging.html";i:1521419346;s:85:"D:\phpStudy\PHPTutorial\WWW\maccmsV10.3.06\template\default_wap\html\public\foot.html";i:1522744369;}*/ ?>
...
<header class="g_nav trans">
    ...
    <div class="g_wrap_p">
        ...
        <div class="resou">
            <?php $_5d4178673b531=explode(',',$maccms['search_hot']); if(is_array($_5d4178673b531) || $_5d4178673b531 instanceof \think\Collection || $_5d4178673b531 instanceof \think\Paginator): if( count($_5d4178673b531)==0 ) : echo "" ;else: foreach($_5d4178673b531 as $key2=>$vo2): ?>
...
<header class="g_header2">
    ...
    <?php echo $obj['type_name']; ?>  <label for="navSwitch" href="javascript:;" class="s_r s_bt"><i class="i_bread"><span></span></i></label>
</header>
<!-- 搜索条件 -->
        ...
        <ul class="selectList" >
            <li id="first_list">
                <div class="con" id="first_list_p">
                    <p>
                        ...
                        <?php $_5d4178673b49d=explode(',',$obj['type_extend']['class']); if(is_array($_5d4178673b49d) || $_5d4178673b49d instanceof \think\Collection || $_5d4178673b49d instanceof \think\Paginator): if( count($_5d4178673b49d)==0 ) : echo "" ;else: foreach($_5d4178673b49d as $key2=>$vo2): ?>
            ...
            <div class="con" id="second_list_p">
                <p>
                    ...
                    <?php $_5d4178673b3df=explode(',',$obj['type_extend']['area']); if(is_array($_5d4178673b3df) || $_5d4178673b3df instanceof \think\Collection || $_5d4178673b3df instanceof \think\Paginator): if( count($_5d4178673b3df)==0 ) : echo "" ;else: foreach($_5d4178673b3df as $key2=>$vo2): ?>
            ...
            <li id="third_list">
                <div class="con" id="third_list_p">
                    <p>
                        ...
                        <?php $_5d4178673b378=explode(',',$obj['type_extend']['year']); if(is_array($_5d4178673b378) || $_5d4178673b378 instanceof \think\Collection || $_5d4178673b378 instanceof \think\Paginator): if( count($_5d4178673b378)==0 ) : echo "" ;else: foreach($_5d4178673b378 as $key2=>$vo2): ?>
...
<div class="box"><i class="clear3"></i>
    <div class="box_con">
        <ul class="img-list">
            <?php $__TAG__ = '{"num":"10","paging":"yes","pageurl":"vod\/show","type":"current","order":"desc","by":"time","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__);$__PAGING__ = mac_page_param($__LIST__['total'],$__LIST__['limit'],$__LIST__['page'],$__LIST__['pageurl'],$__LIST__['half']); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
