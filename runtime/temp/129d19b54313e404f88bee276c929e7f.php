...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_5d4bd8fa9dbf1=explode(',',$maccms['search_hot']); if(is_array($_5d4bd8fa9dbf1) || $_5d4bd8fa9dbf1 instanceof \think\Collection || $_5d4bd8fa9dbf1 instanceof \think\Paginator): if( count($_5d4bd8fa9dbf1)==0 ) : echo "" ;else: foreach($_5d4bd8fa9dbf1 as $key2=>$vo2): ?>
    ...
    <ul class="directory-list">
        <li>
            <dl class="leixing">
                ...
                <?php if(empty($obj['type_extend']['class']) || (($obj['type_extend']['class'] instanceof \think\Collection || $obj['type_extend']['class'] instanceof \think\Paginator ) && $obj['type_extend']['class']->isEmpty())): $_5d4bd8fa9da7b=explode(',',$obj['parent']['type_extend']['class']); if(is_array($_5d4bd8fa9da7b) || $_5d4bd8fa9da7b instanceof \think\Collection || $_5d4bd8fa9da7b instanceof \think\Paginator): if( count($_5d4bd8fa9da7b)==0 ) : echo "" ;else: foreach($_5d4bd8fa9da7b as $key=>$vo): ?>
                    <dd><a href="<?php echo mac_url_type($obj,['class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
                    <?php endforeach; endif; else: echo "" ;endif; else: $_5d4bd8fa9da4f=explode(',',$obj['type_extend']['class']); if(is_array($_5d4bd8fa9da4f) || $_5d4bd8fa9da4f instanceof \think\Collection || $_5d4bd8fa9da4f instanceof \think\Paginator): if( count($_5d4bd8fa9da4f)==0 ) : echo "" ;else: foreach($_5d4bd8fa9da4f as $key=>$vo): ?>
                    <dd><a href="<?php echo mac_url_type($obj,['class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
        ...
        <li>
            <dl class="area">
                ...
                <?php if(empty($obj['type_extend']['area']) || (($obj['type_extend']['area'] instanceof \think\Collection || $obj['type_extend']['area'] instanceof \think\Paginator ) && $obj['type_extend']['area']->isEmpty())): $_5d4bd8fa9d9ee=explode(',',$obj['parent']['type_extend']['area']); if(is_array($_5d4bd8fa9d9ee) || $_5d4bd8fa9d9ee instanceof \think\Collection || $_5d4bd8fa9d9ee instanceof \think\Paginator): if( count($_5d4bd8fa9d9ee)==0 ) : echo "" ;else: foreach($_5d4bd8fa9d9ee as $key=>$vo): ?>
                    <dd><a href="<?php echo mac_url_type($obj,['class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
                    <?php endforeach; endif; else: echo "" ;endif; else: $_5d4bd8fa9d9c1=explode(',',$obj['type_extend']['area']); if(is_array($_5d4bd8fa9d9c1) || $_5d4bd8fa9d9c1 instanceof \think\Collection || $_5d4bd8fa9d9c1 instanceof \think\Paginator): if( count($_5d4bd8fa9d9c1)==0 ) : echo "" ;else: foreach($_5d4bd8fa9d9c1 as $key=>$vo): ?>
        ...
        <li>
            <dl>
                ...
                <?php if(empty($obj['type_extend']['year']) || (($obj['type_extend']['year'] instanceof \think\Collection || $obj['type_extend']['year'] instanceof \think\Paginator ) && $obj['type_extend']['year']->isEmpty())): $_5d4bd8fa9d95d=explode(',',$obj['parent']['type_extend']['year']); if(is_array($_5d4bd8fa9d95d) || $_5d4bd8fa9d95d instanceof \think\Collection || $_5d4bd8fa9d95d instanceof \think\Paginator): if( count($_5d4bd8fa9d95d)==0 ) : echo "" ;else: foreach($_5d4bd8fa9d95d as $key=>$vo): ?>
                    <dd><a href="<?php echo mac_url_type($obj,['class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
                    <?php endforeach; endif; else: echo "" ;endif; else: $_5d4bd8fa9d92a=explode(',',$obj['type_extend']['year']); if(is_array($_5d4bd8fa9d92a) || $_5d4bd8fa9d92a instanceof \think\Collection || $_5d4bd8fa9d92a instanceof \think\Paginator): if( count($_5d4bd8fa9d92a)==0 ) : echo "" ;else: foreach($_5d4bd8fa9d92a as $key=>$vo): ?>
