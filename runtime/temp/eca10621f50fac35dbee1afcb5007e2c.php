<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"template/default_wap/html/comment\ajax.html";i:1529024813;}*/ ?>
    <!--评论开始-->
        ...
        <div class="input_wrap fl clearfix">
            ...
            <div class="fl clearfix handle">
                ...
                <div class="comment_face_box face-box">
                    <?php $__FOR_START_28717__=1;$__FOR_END_28717__=16;for($i=$__FOR_START_28717__;$i <= $__FOR_END_28717__;$i+=1){ ?>
                    <img data-id="<?php echo $i; ?>" src="/maccmsV10.3.06/static/images/face/<?php echo $i; ?>.gif">
                    <?php } ?>
                </div>
