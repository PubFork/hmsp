...
<header class="g_nav trans">
    ...
    <div class="g_wrap_p">
        ...
        <div class="resou">
            <?php $_5d4153cda0d8f=explode(',',$maccms['search_hot']); if(is_array($_5d4153cda0d8f) || $_5d4153cda0d8f instanceof \think\Collection || $_5d4153cda0d8f instanceof \think\Paginator): if( count($_5d4153cda0d8f)==0 ) : echo "" ;else: foreach($_5d4153cda0d8f as $key2=>$vo2): ?>
    ...
    <div class="detail-cols fn-clear">
        ...
        <div class="detail-info fn-left">
            ...
            <div class="info fn-clear">
                ...
                <dl><dt>状态：</dt><dd><span class="color"><?php echo $obj['vod_version']; ?></span></dd></dl>
                <dl class="fn-left"><dt>语言：</dt><dd><span><?php echo $obj['vod_lang']; ?></span></dd></dl>
                <dl><dt>时间：</dt><dd><span id="addtime"><?php echo date('Y-m-d',$obj['vod_time']); ?></span></dd></dl>
                <dl><dt>类型：</dt><dd><?php echo $obj['vod_class']; ?></dd></dl><em><?php echo $obj['vod_score']; ?>分</em>
                <dl><dt>访问量：</dt><dd><span class="mac_hits hits" data-mid="<?php echo $maccms['mid']; ?>" data-id="<?php echo $obj['vod_id']; ?>" data-type="hits"></span></dd></dl>
                <a href="javascript:;" class="mac_ulog" data-type="2" data-mid="<?php echo $maccms['mid']; ?>" data-id="<?php echo $obj['vod_id']; ?>">我要收藏</a>
            </div>
        </div>
    </div>
</div>
...
<section class="tab_box">
    ...
    <section id="zzjs_zzjs2" style="display:none;">
        <div id="juqing" >
            <div class="info fn-clear">
                ...
                <dl class="fn-left"><dt>导演：</dt><dd><?php echo mac_url_create($obj['vod_director'],'director'); ?></dd></dl>
    ...
    <section id="zzjs_zzjs3" style="display:;">
        <!--WAP版评论-->
