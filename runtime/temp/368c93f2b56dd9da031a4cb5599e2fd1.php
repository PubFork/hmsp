...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_5d40653b6f6d2=explode(',',$maccms['search_hot']); if(is_array($_5d40653b6f6d2) || $_5d40653b6f6d2 instanceof \think\Collection || $_5d40653b6f6d2 instanceof \think\Paginator): if( count($_5d40653b6f6d2)==0 ) : echo "" ;else: foreach($_5d40653b6f6d2 as $key2=>$vo2): ?>
